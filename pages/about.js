...
export default function About() {
  return (
    <>
      <Head>
        <title>About | Grant Imbo - Front-end Developer & 3D Artist</title>
      </Head>
      ...
      <section className="about">
        <article>
          ...
          <h3>
            2012-2014 : Graphic Designer, WordPress Developer and Front-end
            Developer
          </h3>
          <ul>
            <li>
          ...
          <p>
            ...
            Feel free to contact me at <span>grant.imbo@gmail.com</span>
          </p>

          <p>
            Or just want to be friends? Find me online on most digital platforms{" "}
            <span>@grantimbo</span> or <span>@grntx</span> or by clicking the
            links below.{" "}
          </p>
          <SocialIcons />
        </article>
